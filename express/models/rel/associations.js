module.exports = (models) => {
  ...
  models.users.belongsToMany(models.threads, {
    through: "threadSubscriptions",
    as: "subscribedThreads",
    foreignKey: "subscriberId",
  });
  models.threads.belongsToMany(models.users, {
    through: "threadSubscriptions",
    as: "subscribers",
    foreignKey: "threadId",
  });
  ...
  // 1 : n Group to Posts
  models.groups.hasMany(models.groupPosts, {
    foreignKey: { name: "groupId", allowNull: false },
    as: "groupPosts",
  });
  models.groupPosts.belongsTo(models.groups, {
    foreignKey: { name: "groupId", allowNull: false },
  });
  // 1 : n User to Group Posts
  models.users.hasMany(models.groupPosts, {
    foreignKey: { name: "authorId", allowNull: false },
    as: "groupPosts",
  });
  models.groupPosts.belongsTo(models.users, {
    foreignKey: { name: "authorId", allowNull: false },
    as: "author",
  });
};
